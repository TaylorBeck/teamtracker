class Rsvp < ActiveRecord::Base
  ...
  handle_asynchronously :send_reminder_automatically, :run_at => Proc.new { 7.days.from_now }
  handle_asynchronously :send_reminder_automatically, :run_at => Proc.new { 3.days.from_now }
  handle_asynchronously :send_reminder_automatically, :run_at => Proc.new { 2.days.from_now }
