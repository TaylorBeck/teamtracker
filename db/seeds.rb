...
# create teams
team1 = Team.create(name: "Gary's Gilligans", sport: soccer, ideal_players: 6, min_players: 4, min_females: 2, manager: gary)
team2 = Team.create(name: "Gary's Gophers", sport: volleyball, ideal_players: 4, min_players: 2, min_females: 1, manager: gary)
team3 = Team.create(name: "Gary's Giraffes", sport: basketball, ideal_players: 5, min_players: 4, min_females: 2, manager: gary)
...
# create games
game1 = Game.create(team: team1, date: DateTime.now, time: DateTime.now, location: 'North Clairemont Rec Center')
game2 = Game.create(team: team2, date: DateTime.now, time: DateTime.now, location: 'South Clairemont Rec Center')
game3 = Game.create(team: team1, date: DateTime.now, time: DateTime.now, location: 'East Clairemont Rec Center')
game4 = Game.create(team: team3, date: DateTime.now, time: DateTime.now, location: 'West Clairemont Rec Center')
game5 = Game.create(team: team4, date: DateTime.now, time: DateTime.now, location: 'North Clairemont Rec Center')
game6 = Game.create(team: team5, date: DateTime.now, time: DateTime.now, location: 'South Clairemont Rec Center')
game7 = Game.create(team: team6, date: DateTime.now, time: DateTime.now, location: 'East Clairemont Rec Center')
game8 = Game.create(team: team4, date: DateTime.now, time: DateTime.now, location: 'West Clairemont Rec Center')

# create players
mike = Player.create(name: 'Mike', gender: 'm', phone_number: '619-944-8738')
elliot = Player.create(name: 'Elliot', gender: 'm', phone_number: '784-111-2832')
mandy = Player.create(name: 'Mandy', gender: 'f', phone_number: '909-974-8030')
martha = Player.create(name: 'Martha', gender: 'f', phone_number: '555-345-7890')
taylor = Player.create(name: 'Taylor', gender: 'm', phone_number: '858-336-2522')
joe = Player.create(name: 'Joe', gender: 'm', phone_number: '122-344-5678')
jane = Player.create(name: 'Jane', gender: 'f', phone_number: '999-456-2222')
mary = Player.create(name: 'Mary', gender: 'f', phone_number: '858-123-4567')
fred = Player.create(name: 'Fred', gender: 'm', phone_number: '619-765-4321')

# add players to teams (create team-player details)
joeteam1 = TeamPlayerDetail.create(key_position: true, skill_level: 5, player: joe, team: team1)
...
rsvp8 = Rsvp.create(responder: mary, game: game2, response: "yes")
# rsvp9 = Rsvp.create(responder: fred, game: game2, response: "none")

rsvp10 = Rsvp.create(responder: joe, game: game3, response: "yes")
# rsvp11 = Rsvp.create(responder: jane, game: game3, response: "none")
rsvp12 = Rsvp.create(responder: mike, game: game3, response: "yes")
rsvp13 = Rsvp.create(responder: mandy, game: game3, response: "yes")
rsvp14 = Rsvp.create(responder: elliot, game: game3, response: "no")